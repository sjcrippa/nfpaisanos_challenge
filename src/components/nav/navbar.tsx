  ...
  return (
    <>
      <nav className="max-w-screen-xl flex h-20 justify-between">
        ...
        <nav className=
          {`flex w-1/3 mt-16 lg:items-center sm:px-4 lg:gap-3 text-light text-md z-10 h-screen fixed transition-color duration-500 ease-in lg:hidden
        ${!sideMenu ? '-right-[100%]' : 'fixed right-0 shadow-lg shadow-dark'}`}>
